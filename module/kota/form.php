...
<form action="<?php echo BASE_URL."module/kota/action.php?kota_id=$kota_id"?>" method="post">
	...
	<div class="element-form">
		...
		<span class="element-span"><input type="text" name="kota" value="<?php echo $kota; ?>" /></span>
	</div>

	<div class="element-form">
		<label class="element-label">Tarif</label>
		<span class="element-span"><input type="text" name="tarif" value="<?php echo $tarif; ?>" /></span>
	</div>
