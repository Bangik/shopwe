...
<form action="<?php echo BASE_URL."module/user/action.php?user_id=$user_id"?>" method="POST">
	...
	<div class="element-form">
		...
		<span class="element-span"><input type="text" name="nama" value="<?php echo $nama; ?>" /></span>
	</div>

	<div class="element-form">
		<label class="element-label">Email</label>
		<span class="element-span"><input type="text" name="email" value="<?php echo $email; ?>" /></span>
	</div>

	<div class="element-form">
		<label class="element-label">Phone</label>
		<span class="element-span"><input type="text" name="phone" value="<?php echo $phone; ?>" /></span>
	</div>

	<div class="element-form">
		<label class="element-label">Alamat</label>
		<span class="element-span"><input type="text" name="alamat" value="<?php echo $alamat; ?>" /></span>
	</div>

	<div class="element-form">
		<label class="element-label">Level</label>
